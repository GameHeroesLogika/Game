...
button_post_army = Graphic_elements(0,settings['SCREEN_HEIGHT']-SCREEN_CELL_H-button_menu_hero_back.HEIGHT,SCREEN_CELL_W*2.5,SCREEN_CELL_H,'images/post_army_b.png')
