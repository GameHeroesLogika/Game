...
mat_objetcs_lvl1 =[ list('KkkP00000000БCл1000000000Nnгггг'),#M,p,P,E,g,i,c,w,T,t,F,f,H,h,D,d,N,n,R,r,X,x,C,W,A,B,e,m,s
                    ...
                    list('0p0000000000Mл1hh0000000000вв11'),#S-Хижина
                    ...
                    list('00P00000000А00000П0000000000000'),
                    list('000000000000вRr00вв00000000лл1С'),
                    list('0Ff000000000вrr0ввC00000000л110'),
                    list('0ff00000000вввввв000000лллл1100'),
                    list('00000000000в0000000000W1111100C'),
                    list('00000000вввв0000000000л100000лл'),
                    list('М000000вв0000000000000л10лллллл'),
                    list('Cвв000вв00000000000000л1Рл11111'),
