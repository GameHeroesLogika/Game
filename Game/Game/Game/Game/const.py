...
mat_objetcs_lvl1 =[ list('KkkP00000000БCл1000000000Nnгггг'),#M,p,P,E,g,i,c,w,T,t,F,f,H,h,D,d,N,n,R,r,X,x,C,W,A,B,e,m,s
                    ...
                    list('М000000вв0000000.00000л10лллллл'),
...
dict_card_dialog = {
                    'бард':[
                        ['Бард: Стой! Останавись!','',2],
                        ['Бард: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Бард: Спокойно я уйду',1],
                        ['Бард: Благодарю',1],
                        ['Бард: Очень жаль',1],
                        ],
                    'клаус':[
                        ['Клаус: Я, Клаус!','Великий Маг!',2],
                        ['Клаус: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Клаус: Спокойно, мне','не нужны проблемы',2],
                        ['Клаус: Благодарю',1],
                        ['Клаус: Очень жаль',1],
                    ...
                    'гигант':[
                        ['Гигант: Гиганты','большие.',2],
                        ['Гигант: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Гигант: Спокойно, мне','не нужны проблемы',2],
                        ['Гигант: Благодарю',1],
                        ['Гигант: Очень жаль',1],
                    ...
                    'ями':[
                        ['Ями: Призрак ада!','Пожиратель душ, Ями',2],
                        ['Ями: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Ями: Спокойно я уйду',1],
                        ['Ями: Благодарю',1],
                        ['Ями: Очень жаль',1],

                        ],
                    'подрывник':[
                        ['Подрывник: БУМ-БУМ!','Взорву всё вокруг!',2],
                        ['Подрывник: Думаешь,','мне страшно? Я с тебя','шкуру сдеру!',3],
                        ['Подрывник: Спокойно,','мне не нужны проблемы',2],
                        ['Подрывник: Благодарю',1],
                        ['Подрывник: Очень жаль',1],

                        ],
                    'арбалетчик':[
                        ['Арбалетчик: Тетива',' всё упруже!',2],
                        ['Арбалетчик: Думаешь,','мне страшно? Я с тебя','шкуру сдеру!',3],
                        ['Арбалетчик: Спокойно,','мне не нужны проблемы',2],
                        ['Арбалетчик: Благодарю',1],
                        ['Арбалетчик: Очень жаль',1],

                        ],
                    'кентавр':[
                        ['Кентавр: Я не позволю','контролировать меня',2],
                        ['Кентавр: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Кентавр: Спокойно,','мне не нужны проблемы',2],
                        ['Кентавр: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'орк':[
                        ['Орк: Ргррхрхрх!','',2],
                        ['Орк: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Орк: Спокойно я уйду',1],
                        ['Орк: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'дворф':[
                        ['Дворф: Я лучший кузнец','этого мира!',2],
                        ['Дворф: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Дворф: Спокойно, мне','не нужны проблемы',2],
                        ['Дворф: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'рогги':[
                        ['Рогги: Не вставай',' у меня на пути!',2],
                        ['Рогги: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Рогги: Спокойно, мне','не нужны проблемы',2],
                        ['Рогги: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'суртур':[
                        ['Суртур: Огненный меч','правит судьбой',2],
                        ['Суртур: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Суртур: Спокойно, мне','не нужны проблемы',2],
                        ['Суртур: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'лудорн':[
                        ['Лудорн: Мой,Брат','глупец!',2],
                        ['Лудорн: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Лудорн: Спокойно, мне','не нужны проблемы',2],
                        ['Лудорн: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'друид':[
                        ['Друид: Я покровитель','леса.',2],
                        ['Друид: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Друид: Спокойно, мне','не нужны проблемы',2],
                        ['Друид: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'голем':[
                        ['Голем: Братья мои!','Вставайте!',2],
                        ['Голем: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Голем: Спокойно, мне','не нужны проблемы',2],
                        ['Голем: Благодарю',1],
                        ['Бард: Очень жаль',1],
                    ...
                    'рудорн':[
                        ['Рудорн: Мой,Брат','глупец!',2],
                        ['Рудорн: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!',3],
                        ['Рудорн: Спокойно, мне','не нужны проблемы',2],
                        ['Рудорн: Благодарю',1],
                        ['Бард: Очень жаль',1],
