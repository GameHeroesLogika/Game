...
dict_card_dialog = {
                    'бард':[
                        ...
                        ['Бард: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!'],
                        ['Бард: Спокойно, мне','не нужны проблемы'],
                        ['Бард: Благодарю'],
                        ['Бард: Очень жаль'],
                        ['Бард: Да начнётся','битва!'],
                        ],
                    'клаус':[
                        ['Клаус: Я, Клаус!','Великий Маг!'],
                        ['Клаус: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!'],
                        ['Клаус: Спокойно, мне','не нужны проблемы'],
                        ['Клаус: Благодарю'],
                        ['Клаус: Очень жаль'],
                        ['Клаус: Да начнётся','битва!'],


                        ],
                    'гигант':[
                        ['Гигант: Гиганты','большие.'],
                        ['Гигант: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!'],
                        ['Гигант: Спокойно, мне','не нужны проблемы'],
                        ['Гигант: Благодарю'],
                        ['Гигант: Очень жаль'],
                        ['Гигант: Да начнётся','битва!'],


                        ],
                    'ями':[
                        ['Ями: Призрак ада!','Пожиратель душ, Ями'],
                        ['Ями: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!'],
                        ['Ями: Спокойно я уйду'],
                        ['Ями: Благодарю'],
                        ['Ями: Очень жаль'],
                        ['Ями: Да начнётся','битва!'],

                        ],
                    'подрывник':[
                        ['Подрывник: БУМ-БУМ!','Взорву всё вокруг!'],
                        ['Подрывник: Думаешь,','мне страшно? Я с тебя','шкуру сдеру!'],
                        ['Подрывник: Спокойно,','мне не нужны проблемы'],
                        ['Подрывник: Благодарю'],
                        ['Подрывник: Очень жаль'],
                        ['Подрывник: Да начнётся','битва!'],

                        ],
                    'арбалетчик':[
                        ['Арбалетчик: Тетива',' всё упруже!'],
                        ['Арбалетчик: Думаешь,','мне страшно? Я с тебя','шкуру сдеру!'],
                        ['Арбалетчик: Спокойно,','мне не нужны проблемы'],
                        ['Арбалетчик: Благодарю'],
                        ['Арбалетчик: Очень жаль'],
                        ['Арбалетчик: Да начнётся','битва!'],

                        ],
                    'кентавр':[
                        ['Кентавр: Я не позволю','контролировать меня'],
                        ['Кентавр: Думаешь, мне','страшно? Я с тебя','шкуру сдеру!'],
                        ['Кентавр: Спокойно,','мне не нужны проблемы'],
                        ['Кентавр: Благодарю'],
                        ['Кентавр: Очень жаль'],
                        ['Кентавр: Да начнётся','битва!'],
